...
import 'package:wisata_app/models/category_models/forest_place.dart';
...
class HutanScreen extends StatefulWidget {
  const HutanScreen({Key? key}) : super(key: key);

  @override
  _HutanScreenState createState() => _HutanScreenState();
}

class _HutanScreenState extends State<HutanScreen> {
  @override
        ...
        child: Container(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              final ForestPlace place = forestPlaceList[index];
            ...
            itemCount: forestPlaceList.length,
          ),
        ),
      ),
    );
