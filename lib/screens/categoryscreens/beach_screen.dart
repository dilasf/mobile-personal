...
import 'package:wisata_app/models/category_models/beach_place.dart';
...
class PantaiScreen extends StatefulWidget {
  const PantaiScreen({Key? key}) : super(key: key);

  @override
  _PantaiScreenState createState() => _PantaiScreenState();
}

class _PantaiScreenState extends State<PantaiScreen> {
  @override
