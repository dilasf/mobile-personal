...
import 'package:wisata_app/models/category_models/mountain_place.dart';
...
class PegununganScreen extends StatefulWidget {
  const PegununganScreen({Key? key}) : super(key: key);

  @override
  _PegununganScreenState createState() => _PegununganScreenState();
}

class _PegununganScreenState extends State<PegununganScreen> {
  @override
        ...
        child: Container(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              final MountainPlace place = mountainPlaceList[index];
            ...
            itemCount: mountainPlaceList.length,
          ),
        ),
      ),
    );
