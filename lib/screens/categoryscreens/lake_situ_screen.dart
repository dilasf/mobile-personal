...
import 'package:wisata_app/models/category_models/lake_place.dart';
...
class DanauSituScreen extends StatefulWidget {
  const DanauSituScreen({Key? key}) : super(key: key);

  @override
  _DanauSituScreenState createState() => _DanauSituScreenState();
}

class _DanauSituScreenState extends State<DanauSituScreen> {
  @override
        ...
        child: Container(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              final LakePlace place = lakePlaceList[index];
            ...
            itemCount: lakePlaceList.length,
          ),
        ),
      ),
    );
