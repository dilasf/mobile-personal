...
import 'package:wisata_app/models/category_models/river_place.dart';
...
class SungaiScreen extends StatefulWidget {
  const SungaiScreen({Key? key}) : super(key: key);

  @override
  _SungaiScreenState createState() => _SungaiScreenState();
}

class _SungaiScreenState extends State<SungaiScreen> {
  @override
        ...
        child: Container(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              final RiverPlace place = riverPlaceList[index];
            ...
            itemCount: riverPlaceList.length,
          ),
        ),
      ),
    );
